...
final readonly class ChronosSoftDelete implements SchemaModifierInterface
{
    public function __construct(private string $field = 'deletedAt', private ?string $column = null) {}
