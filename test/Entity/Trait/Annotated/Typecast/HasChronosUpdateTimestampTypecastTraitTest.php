...
final class HasChronosUpdateTimestampTypecastTraitTest extends TestCase
{
    ...
    {
        $this->assertTrue(property_exists($this->traitObject, 'updatedAt'));
    }

    public function testColumnAttribute(): void
    {
        $reflection = new ReflectionProperty($this->traitObject, 'updatedAt');
    ...
    {
        $reflection = new ReflectionProperty($this->traitObject, 'updatedAt');
        $attributes = $reflection->getAttributes(ChronosToTimestampType::class);
