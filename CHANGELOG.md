...
- Typecast and entity identifier APIs now throw package exceptions instead of PHP or dependency-specific exceptions.
...
- Added `TypecastInvalidArgumentException` for typecast validation failures.
